...
export const metadata = {
    ...
    description:
        "Создание и размещение эффективных тизеров для привлечения аудитории. Увеличьте охват и внимание к вашему продукту с помощью ярких и запоминающихся рекламных тизеров.",
    alternates: {
