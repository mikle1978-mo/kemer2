...
export const metadata = {
    ...
    title: {
        default: "Интернет магазин Кемера. Продукты и товары с доставкой",
    ...
    keywords: [
        ...
        "Торговая площадка",
        "Доставка по Кемеру",
        "Недорогие товары Кемер",
        "Скидки на продукты Кемер",
        "Онлайн покупки Кемер",
        "Товары с доставкой Кемер",
        "Акции в Кемере",
        "Продукты онлайн Кемер",
    ],
};
